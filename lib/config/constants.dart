...
class GameColors {
  ...
  static const Color primary = Color(0xFFF9C80E);
  static const Color secondary = Color(0xFFF86624);
  static const Color accent = Color(0xFFEA3546);
  static const Color success = Color(0xFF662E9B);
  static const Color warning = Color(0xFF43BCCD);
